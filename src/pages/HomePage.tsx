...
import { homeContent } from '../generated/structured'
          ...
          <div className="sections-container-inner">
            <div className="row">
              <div className="col-sm-12">
                <section className="section-container divider-section -space -space"><hr /></section>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-sm-12">
                <section className="section-container text-section -default wysiwyg">
                  <blockquote>
                    {homeContent.quote.map((line) => <p style={{ textAlign: 'left' }} key={line}>{line}</p>)}
                  </blockquote>
                </section>
              </div>
            </div>
